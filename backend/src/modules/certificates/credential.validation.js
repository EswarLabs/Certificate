...
export const createCredentialSchema = z.object({
  ...
  recipientEmail: z.preprocess(val => val === "" ? null : val, z.string().trim().email("Invalid recipient email").optional().nullable()),
...
export const createBatchCredentialSchema = z.object({
  ...
  recipientEmailColumn: z.preprocess(val => val === "" ? null : val, z.string().trim().min(1, "Recipient email column mapping is required").optional().nullable()),
